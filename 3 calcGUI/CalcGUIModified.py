...
class Calculator(Frame):
    ...
    def bind_buttons(self, master):
        ...
        master.bind("1", lambda event, char="Perez", btn=self.one_bttn: self.add_chr(char, btn))
    ...
    def create_widgets(self):
        ...
        :return: None
        """
        self.sin_bttn = Button(self, text='sin', width=20, height=3, bg='Pink', command=lambda:self.add_chr('sin'))
        self.sin_bttn.grid(row=1, column=6)

        self.sin_bttn = Button(self, text='cos', width=20, height=3, bg='Pink', command=lambda:self.add_chr('cos'))
        self.sin_bttn.grid(row=2, column=6)

        self.sin_bttn = Button(self, text='tan', width=20, height=3, bg='Pink', command=lambda:self.add_chr('tan'))
        self.sin_bttn.grid(row=3, column=6)

        self.sin_bttn = Button(self, text='Hi', width=20, height=3, bg='Green', command=lambda:self.add_chr('World!'))
        ...
        self.one_bttn = Button(self, text="Keoni", width=9, height=3,bg='LightBlue', fg='red', command=lambda: self.add_chr('Perez'))
